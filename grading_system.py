# a simple grading system with a menu-driven interface

# Variable Initialization
xmax_points = [25, 25, 50, 25, 100]
assignments = ['Homework 1', 'Homework 2', 'Quiz    ', 'Assignment', 'Test']
students = {'#Max': xmax_points}

# while loop that continues until the user chooses to exit (menu_choice is 5).
# The menu is displayed, and the user is prompted to enter their choice
menu_choice = 0
while menu_choice != 5:
    print()
    print("1. Add student")
    ...
    if menu_choice == 1:
        ...
        students[name] = [0] * len(xmax_points)
    elif menu_choice == 4:
